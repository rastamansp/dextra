...
module.exports = function(context) {
    ...
    funcoes.loginUsuario = function(form, done) {
        // Utilitarios do javascript
        var _ = context.module('lodash');
    ...
    /**
     * Executa a consulta usuarios.
     * @public
     * @function consultarUsuario
     * @param {object} pesquisa Campo de pesquisa de usuarios.
     * @param {callback} done Callback de retorno.
     */
    funcoes.consultarUsuarios = function(pesquisa, done) {
