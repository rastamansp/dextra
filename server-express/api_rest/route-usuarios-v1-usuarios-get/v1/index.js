/**
 * @file Pesquisar usuario.
 * @since 2017-07-13
 * @author @pedroalmeida.
 */
'use strict';
/**
 * Controller da API de pesquisa de usuario.
 * @public
 * @function controller
...
module.exports.controller = function(req, res, context) {
    ...
    var usuario = context.localModule('validarUsuario')(context);
    ...
    // Chama processor
    var processor = context.processor('pesquisarUsuario')(context);
