/**
 * @file Processor de atualização de ingrediente.
 * @since 2017-06-12
 * @author @pedroalmeida.
 */
'use strict';
...
module.exports = function(context) {
     ...
     */
    metodos.executa = function(ingrediente, atualizacao, done) {
        ...
        var service = context.service('atualizarIngrediente')(context);

        // Obtendo informações do ingrediente
        var request = {
            ingrediente: {
                _id: ingrediente.id
            },
